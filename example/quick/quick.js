...
const MASTER_CA_FILE = path.join(__dirname, '../../cert/master_gateway_ca.crt');
const MASTER_IP = 'localhost';
const MASTER_PORT = 4000;
const TENANT_CERT_FILE = path.join(__dirname, '../../cert/tenant_matias.crt');
const TENANT_KEY_FILE = path.join(__dirname, '../../cert/tenant_matias_key.pem');
const ADMIN_CERT_FILE = path.join(__dirname, '../../cert/admin.crt');
const ADMIN_KEY_FILE = path.join(__dirname, '../../cert/admin_key.pem');

const TENANT_ID = "matias";
const GATEWAY_ID = "matias_gateway";
